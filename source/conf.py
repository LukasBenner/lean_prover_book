...
latex_documents = [
    (master_doc, 'title_of_the_book.tex', 'TITLE OF THE BOOK',
     'Max Mustermann', 'manual'),
]
...
man_pages = [
    (master_doc, 'title_of_the_book', 'TITLE OF THE BOOK',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'title_of_the_book', 'TITLE OF THE BOOK',
     author, 'title_of_the_book', 'A tutorial introduction to Lean',
     'Miscellaneous'),
]
